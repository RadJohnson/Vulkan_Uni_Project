...
namespace Lve
{
	...
	Pipeline::~Pipeline() 
	{
		vkDestroyShaderModule(engineDevice.device(), vertShader, nullptr);
		vkDestroyShaderModule(engineDevice.device(), fragShader, nullptr);
	...
	/*PipelineConfigInfo Pipeline::defualtPipelineConfigInfo(uint32_t width, uint32_t height)
	{
