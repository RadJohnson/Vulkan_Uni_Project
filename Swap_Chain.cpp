...
VkResult Swap_Chain::submitCommandBuffers(const VkCommandBuffer *buffers, uint32_t *imageIndex) 
{   
...
VkSurfaceFormatKHR Swap_Chain::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR> &availableFormats) 
{
...
VkPresentModeKHR Swap_Chain::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> &availablePresentModes) 
{
  //mailbox constantly uses gpu to draw images to buffer even when waiting to present
